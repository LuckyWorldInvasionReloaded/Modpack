...
- Nouveau mod : Immersive Hotbar. La barre bleue de Lucky XP reprend ses animations en bleu et suit ses réglages.
- Les deux barres d'XP se lisent comme une paire : niveaux centrés tous les deux, présentes dès l'apparition, masquées en créatif.

## Mods
- Lucky Tweaks 1.1.2 vers 1.1.3
- Lucky XP 1.0.2 vers 1.0.3
- Ajout d'Immersive Hotbar 1.1.2
